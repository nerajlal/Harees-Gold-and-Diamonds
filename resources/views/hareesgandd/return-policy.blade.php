...
<div class="section">
    <div class="section-header">
        <h2 class="section-title">Return <em>Policy</em></h2>
    </div>
    <div style="max-width: 800px; margin: 0 auto; line-height: 1.8;">
        <p>We want you to love your Harees Gold Diamonds purchase. If you are not completely satisfied, we are here to help.</p>
        <br>
        <h3>Returns</h3>
